...
- 1-2 cards (squat, lunge per decision.md D4), stacked or side-by-side depending on available width — `surface-card` (#1F2025) background, large rounded corners (design.md).
